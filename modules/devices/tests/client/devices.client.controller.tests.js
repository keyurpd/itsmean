  ...
  describe('Devices Controller Tests', function () {
    ...
    describe('vm.save() as create', function () {
      ...
      it('should send a POST request with the form input values and then locate to new object URL', inject(function (DevicesService) {
        ...
        expect($state.go).toHaveBeenCalledWith('devices.view', {
    ...
    describe('vm.save() as update', function () {
      ...
      it('should set $scope.vm.error if error', inject(function (DevicesService) {
    ...
    describe('vm.remove()', function () {
      ...
      it('should delete the Device and redirect to Devices', function () {
        ...
        expect($state.go).toHaveBeenCalledWith('devices.list');
      });
